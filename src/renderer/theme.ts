 ...
 * Imported by renderer.js (canvas colors) and
 * IrrigationDigitalTwin.jsx (UI chrome colors).
 *
 * Rule: nothing here except plain data — no functions, no imports.
 * To add a new theme, append a new key to THEMES.
 */
...
export const THEMES = {
    ...
    canalWater:  "#2478b8",   // narrow water-surface stroke (flowing)
    canalEmpty:  "#8aaabb",   // narrow water-surface stroke (dry)
